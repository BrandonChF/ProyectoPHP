...
<div class="mb-3">
  ...
  <input type="number" class="form-control" name="cedula" id="cedula" 
    aria-describedby="helpId" 
    required="true" placeholder="Ingresa la cedula del profesor"
...
<div class="mb-3">
  ...
  <input type="email" 
    ...
    aria-describedby="helpId" required="true" 
...
<div class="mb-3">
  ...
  <input type="number" class="form-control" name="telefonocelular" 
    id="telefonocelular" aria-describedby="helpId" required="true" 
...
<div class="mb-3">
  ...
  <input type="date" class="form-control" name="fechanacimiento" 
    id="fechanacimiento" aria-describedby="helpId" required="true" 
    placeholder="Ingresa la Fecha Nacimiento del profesor"
...
<div class="mb-3">
  ...
  <input type="text" class="form-control" name="direccion"
    id="direccion" aria-describedby="helpId" required="true" 
...
<div class="mb-3">
  ...
  <input type="text" class="form-control" name="nacionalidad" id="nacionalidad" 
    aria-describedby="helpId" required="true" 
    placeholder="Ingresa la  Nacionalidad profesor"
...
<div class="mb-3">
    ...
    <select class="form-select form-select-md" value="" name="idcarreras" 
        id="idcarreras" required="true">
